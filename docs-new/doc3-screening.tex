...
dual to each other under Fenchel--Rockafellar duality. As a by-product,
...
\qquad C>0,
\]
is represented in Fenchel--Rockafellar form by \(p=(f,g,A,0)\), where
...
Section~\ref{sec:operators}'s Translation Duality alone, rather than
needing a separate argument for each screening type.
...
from \(g\). Fenchel--Rockafellar duality exchanges domain translations
